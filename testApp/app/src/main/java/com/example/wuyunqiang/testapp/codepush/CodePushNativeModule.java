...
public class CodePushNativeModule extends ReactContextBaseJavaModule {
    ...
    private com.example.wuyunqiang.testapp.codepush.CodePush mCodePush;
    private SettingsManager mSettingsManager;
    private CodePushTelemetryManager mTelemetryManager;
    private CodePushUpdateManager mUpdateManager;

    public CodePushNativeModule(ReactApplicationContext reactContext, com.example.wuyunqiang.testapp.codepush.CodePush codePush, CodePushUpdateManager codePushUpdateManager, CodePushTelemetryManager codePushTelemetryManager, SettingsManager settingsManager) {
        super(reactContext);
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put("codePushInstallModeImmediate", com.example.wuyunqiang.testapp.codepush.CodePushInstallMode.IMMEDIATE.getValue());
        constants.put("codePushInstallModeOnNextRestart", com.example.wuyunqiang.testapp.codepush.CodePushInstallMode.ON_NEXT_RESTART.getValue());
        constants.put("codePushInstallModeOnNextResume", com.example.wuyunqiang.testapp.codepush.CodePushInstallMode.ON_NEXT_RESUME.getValue());
        constants.put("codePushInstallModeOnNextSuspend", com.example.wuyunqiang.testapp.codepush.CodePushInstallMode.ON_NEXT_SUSPEND.getValue());
    ...
    private ReactInstanceManager resolveInstanceManager() throws NoSuchFieldException, IllegalAccessException {
        ReactInstanceManager instanceManager = com.example.wuyunqiang.testapp.codepush.CodePush.getReactInstanceManager();
        if (instanceManager != null) {
        ...
        AsyncTask<Void, Void, Void> asyncTask = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    CodePushUtils.setJSONValueForKey(mutableUpdatePackage, com.example.wuyunqiang.testapp.codepush.CodePushConstants.BINARY_MODIFIED_TIME_KEY, "" + mCodePush.getBinaryResourcesModifiedTime());
                    mUpdateManager.downloadPackage(mutableUpdatePackage, mCodePush.getAssetsBundleFileName(), new DownloadProgressCallback() {
                        ...
                        public void dispatchDownloadProgressEvent() {
                            getReactApplicationContext()
                                    ...
                                    .emit(com.example.wuyunqiang.testapp.codepush.CodePushConstants.DOWNLOAD_PROGRESS_EVENT_NAME, latestDownloadProgress.createWritableMap());
                        }
                    }, mCodePush.getPublicKey());

                    JSONObject newPackage = mUpdateManager.getPackage(CodePushUtils.tryGetString(updatePackage, com.example.wuyunqiang.testapp.codepush.CodePushConstants.PACKAGE_HASH_KEY));
    ...
    public void getConfiguration(Promise promise) {
        ...
        if (mBinaryContentsHash != null) {
            configMap.putString(com.example.wuyunqiang.testapp.codepush.CodePushConstants.PACKAGE_HASH_KEY, mBinaryContentsHash);
        }
    ...
    public void getUpdateMetadata(final int updateState, final Promise promise) {
        AsyncTask<Void, Void, Void> asyncTask = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (currentPackage.has(com.example.wuyunqiang.testapp.codepush.CodePushConstants.PACKAGE_HASH_KEY)) {
                    String currentHash = currentPackage.optString(com.example.wuyunqiang.testapp.codepush.CodePushConstants.PACKAGE_HASH_KEY, null);
    ...
    public void installUpdate(final ReadableMap updatePackage, final int installMode, final int minimumBackgroundDuration, final Promise promise) {
        AsyncTask<Void, Void, Void> asyncTask = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (installMode == com.example.wuyunqiang.testapp.codepush.CodePushInstallMode.ON_NEXT_RESUME.getValue() ||
                    // We also add the resume listener if the installMode is IMMEDIATE, because
                    // if the current activity is backgrounded, we want to reload the bundle when
                    // it comes back into the foreground.
                    installMode == com.example.wuyunqiang.testapp.codepush.CodePushInstallMode.IMMEDIATE.getValue() ||
                    installMode == com.example.wuyunqiang.testapp.codepush.CodePushInstallMode.ON_NEXT_SUSPEND.getValue()) {
                        ...
                        mLifecycleEventListener = new LifecycleEventListener() {
                            ...
                            public void onHostResume() {
                                ...
                                if (lastPausedDate != null) {
                                    ...
                                    if (installMode == com.example.wuyunqiang.testapp.codepush.CodePushInstallMode.IMMEDIATE.getValue()
