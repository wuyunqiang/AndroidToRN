...
public class FileUtils {
        ...
        for (File sourceFile : sourceDir.listFiles()) {
            if (sourceFile.isDirectory()) {
                copyDirectoryContents(
                        com.example.wuyunqiang.testapp.codepush.CodePushUtils.appendPathComponent(sourceDirectoryPath, sourceFile.getName()),
                        com.example.wuyunqiang.testapp.codepush.CodePushUtils.appendPathComponent(destinationDirectoryPath, sourceFile.getName()));
            } else {
    ...
    public static void deleteDirectoryAtPath(String directoryPath) {
        if (directoryPath == null) {
            com.example.wuyunqiang.testapp.codepush.CodePushUtils.log("deleteDirectoryAtPath attempted with null directoryPath");
            return;
        }
    ...
    public static void deleteFileOrFolderSilently(File file) {
        ...
        if (!file.delete()) {
            com.example.wuyunqiang.testapp.codepush.CodePushUtils.log("Error deleting file " + file.getName());
        }
    }
    ...
    public static void moveFile(File fileToMove, String newFolderPath, String newFileName) {
        ...
        if (!fileToMove.renameTo(newFilePath)) {
            throw new com.example.wuyunqiang.testapp.codepush.CodePushUnknownException("Unable to move file from " +
