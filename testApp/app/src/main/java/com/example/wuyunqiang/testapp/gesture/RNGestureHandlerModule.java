...
import com.example.wuyunqiang.testapp.gesturehandler.LongPressGestureHandler;
import com.example.wuyunqiang.testapp.gesturehandler.NativeViewGestureHandler;
import com.example.wuyunqiang.testapp.gesturehandler.OnTouchEventListener;
import com.example.wuyunqiang.testapp.gesturehandler.PanGestureHandler;
import com.example.wuyunqiang.testapp.gesturehandler.PinchGestureHandler;
import com.example.wuyunqiang.testapp.gesturehandler.RotationGestureHandler;
import com.example.wuyunqiang.testapp.gesturehandler.TapGestureHandler;
...
public class RNGestureHandlerModule extends ReactContextBaseJavaModule {
  ...
  private @Nullable
  RNGestureHandlerRootHelper findRootHelperForViewAncestor(int viewTag) {
    UIManagerModule uiManager = getReactApplicationContext().getNativeModule(UIManagerModule.class);
